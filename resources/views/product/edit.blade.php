             ...
             <div class="container mx-auto px-6 py-1 pb-16">
               <div class="bg-white shadow-md rounded my-6 p-5">
                 ...
                 <div class="flex flex-col space-y-2">
                     ...
                     <textarea name="description" id="description" placeholder="Enter description" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200" rows="5">{{ old('description',$product->description) }}</textarea>
                 </div><br>
                 ...
                 <div class="flex flex-col space-y-2">
                    ...
                    <input id="color" type="text" name="color" value="{{ old('color',$product->color) }}"
                      placeholder="Enter color" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
                    />
                </div><br>

                 <div class="flex flex-col space-y-2">
                    <label for="height_cm" class="text-gray-700 select-none font-medium">Hoogte_cm</label>
                    <input id="height_cm" type="number" name="height_cm" value="{{ old('height_cm',$product->height_cm) }}"
                      placeholder="Enter height_cm" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
                    />
                </div><br>

                 <div class="flex flex-col space-y-2">
                    <label for="width_cm" class="text-gray-700 select-none font-medium">Breedte_cm</label>
                    <input id="width_cm" type="number" name="width_cm" value="{{ old('width_cm',$product->width_cm) }}"
                      placeholder="Enter width_cm" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
                    />
                </div><br>

                 <div class="flex flex-col space-y-2">
                    <label for="depth_cm" class="text-gray-700 select-none font-medium">Diepte_cm</label>
                    <input id="depth_cm" type="number" name="depth_cm" value="{{ old('depth_cm',$product->depth_cm) }}"
                      placeholder="Enter depth_cm" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
                    />
                </div><br>

                 <div class="flex flex-col space-y-2">
                    <label for="weight_gr" class="text-gray-700 select-none font-medium">Gewicht_gr</label>
                    <input id="weight_gr" type="number" name="weight_gr" value="{{ old('weight_gr',$product->weight_gr) }}"
                      placeholder="Enter weight_gr" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
                    />
                </div><br>
